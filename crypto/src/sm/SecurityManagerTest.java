...
/**
 * -Djava.security.manager -Djava.security.policy=policy/test.policy
 */
public class SecurityManagerTest {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		String propiedad = AccessController.doPrivileged(new PrivilegedAction<String>() {
